...
#[derive(Debug)]
pub(crate) struct AccGuardS<'a, CState>
where
    CState: ControlState,
{
...
impl<'a, CState> AccGuardS<'a, CState>
where
    CState: ControlState,
{
...
impl<CState> Deref for AccGuardS<'_, CState>
where
    CState: ControlState,
{
    ...
    State: ControlState,
{
    ...
    pub(crate) fn take_acc(&self, replacement: State::Acc) -> State::Acc {
